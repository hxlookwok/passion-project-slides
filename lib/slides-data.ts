...
export const lessons: Lesson[] = [
  {
    ...
    homework: "Talk to 2 people about a problem you noticed. Jot down what they say.",
  ...
  },
  {
    ...
    activity: "Create a simple user persona — name, age, what they want, what frustrates them.",
  ...
  },
  {
    ...
    icon: Hammer,
    goal: "Create a rough MVP — a website, campaign plan, prototype, or product concept.",
